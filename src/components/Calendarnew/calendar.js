 ...
 Component({
     ...
     methods: {
         ...
         _setCalendarData: function (year, month) {
             ...
             for (let i = 0; i < days.length; i++) {
                 ...
                 if (solarDay > 0) {
                     ...
                     days[i]['lunarMonth2'] = lunarDate.month;
                     days[i]['lunarDay2'] = lunarDate.day;
                     days[i]['lunarYear'] = lunarDate.year;
         ...
         nextMonth: function () {
             ...
             eventDetail.monthArr=this.data.days_array
             this.triggerEvent('ffff', eventDetail);
         },
         ...
         prevMonth: function () {
             ...
             eventDetail['currentMonth'] = this.data.month;
             eventDetail.monthArr=this.data.days_array
             this.triggerEvent('dddd', eventDetail);
         },
